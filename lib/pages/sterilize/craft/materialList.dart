...
class CraftMaterialList extends StatefulWidget {
  final arguments;
  CraftMaterialList({Key key, this.arguments}) : super(key: key);

  @override
  _CraftMaterialListState createState() => _CraftMaterialListState();
}

class _CraftMaterialListState extends State<CraftMaterialList> {
